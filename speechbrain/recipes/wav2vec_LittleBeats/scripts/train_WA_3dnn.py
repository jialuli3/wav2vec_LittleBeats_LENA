...
class EmoIdBrain(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        outputs_sp = self.get_wa_outputs(outputs,self.modules.weighted_average_sp,self.modules.dnn_sp,self.modules.output_mlp_sp, mean_pool_first=self.hparams.mean_pool_first_sp, lens = lens)
        outputs_chn = self.get_wa_outputs(outputs,self.modules.weighted_average_chn,self.modules.dnn_chn,self.modules.output_mlp_chn, mean_pool_first=self.hparams.mean_pool_first_chn, lens = lens)
        outputs_adu = self.get_wa_outputs(outputs,self.modules.weighted_average_adu,self.modules.dnn_adu,self.modules.output_mlp_adu, mean_pool_first=self.hparams.mean_pool_first_adu, lens = lens)
